...
public class CGMenubar extends JMenuBar
{
	...
	private static JMenuItem reset, changelog, settings, link, folder, exit;
	...
	public CGMenubar()
	{
		...
		settings.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (DisplayHelper.showQuestion(panel, Lang.get("GUI:settings"))) return;
				CommandGenerator.opt.update(panel);
			}
		});
