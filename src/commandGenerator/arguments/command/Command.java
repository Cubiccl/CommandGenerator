...
public enum Command
{
	...
	gamerule("gamerule", "gamerule <rule name> <value>", Structure.gameruleNormal, Structure.gameruleNormalCustom, Structure.gameruleQuery,
			Structure.gameruleQueryCustom),
